...
bool compareHands(Hand* h1, Hand* h2) {
    ...
    if (jokerCount1 > 0 && jokerCount1 < 5) {
        vector<char> keys;
        vector<int> values;
        ...
        count1[keys[iMax]] += jokerCount1;
    }
    else if (jokerCount1 == 5) {
        count1.insert(pair<char, int>('J', 5));
    }
    ...
    if (jokerCount2 > 0 && jokerCount2 < 5) {
        vector<char> keys;
        vector<int> values;
        ...
        count2[keys[iMax]] += jokerCount2;
    }
    else if (jokerCount2 == 5) {
        count2.insert(pair<char, int>('J', 5));
    }
